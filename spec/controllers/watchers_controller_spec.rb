  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved watcher as @watcher" do
        ...
        post :create, {:watcher => { "reef_tank_id" => "invalid value" }}, valid_session
        assigns(:watcher).should be_a_new(Watcher)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested watcher" do
        ...
        Watcher.any_instance.should_receive(:update_attributes).with({ "reef_tank_id" => "1" })
        put :update, {:id => watcher.to_param, :watcher => { "reef_tank_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the watcher as @watcher" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Watcher.any_instance.stub(:save).and_return(false)
        put :update, {:id => watcher.to_param, :watcher => { "reef_tank_id" => "invalid value" }}, valid_session
        assigns(:watcher).should eq(watcher)
      end
