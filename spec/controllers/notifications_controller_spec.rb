  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved notification as @notification" do
        ...
        post :create, {:notification => { "reef_tank_id" => "invalid value" }}, valid_session
        assigns(:notification).should be_a_new(Notification)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested notification" do
        ...
        Notification.any_instance.should_receive(:update_attributes).with({ "reef_tank_id" => "1" })
        put :update, {:id => notification.to_param, :notification => { "reef_tank_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the notification as @notification" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Notification.any_instance.stub(:save).and_return(false)
        put :update, {:id => notification.to_param, :notification => { "reef_tank_id" => "invalid value" }}, valid_session
        assigns(:notification).should eq(notification)
      end
