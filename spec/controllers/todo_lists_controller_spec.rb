  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved todo_list as @todo_list" do
        ...
        post :create, {:todo_list => { "reef_tank_id" => "invalid value" }}, valid_session
        assigns(:todo_list).should be_a_new(TodoList)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested todo_list" do
        ...
        TodoList.any_instance.should_receive(:update_attributes).with({ "reef_tank_id" => "1" })
        put :update, {:id => todo_list.to_param, :todo_list => { "reef_tank_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the todo_list as @todo_list" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        TodoList.any_instance.stub(:save).and_return(false)
        put :update, {:id => todo_list.to_param, :todo_list => { "reef_tank_id" => "invalid value" }}, valid_session
        assigns(:todo_list).should eq(todo_list)
      end
